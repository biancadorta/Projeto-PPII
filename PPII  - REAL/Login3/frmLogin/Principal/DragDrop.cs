...
namespace Principal
{
    ...
    {
        private Principal p;
        private frmQuiz quiz;
        private String email = "";
        private float timer = 0;
        private static Image erro = Image.FromFile("F:/3º Semestre/PPII/imagens s2/erradoo.jpg");
        private static Image certo = Image.FromFile("F:/3º Semestre/PPII/imagens s2/certoo.jpg");
        ...
        private void pic1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                if (pic1.BackgroundImage.Equals(picbMercurio.BackgroundImage))
                    picValida.BackgroundImage = certo;
                else
                    picValida.BackgroundImage = erro;
        ...
        private void pic2_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            { 
                if(pic2.BackgroundImage.Equals(picVenus.BackgroundImage))
                    picValida2.BackgroundImage = certo;
                else
                    picValida2.BackgroundImage = erro;
            }
        }
        ...
        private void pic3_MouseMove(object sender, MouseEventArgs e)
        {
            if (pic3.BackgroundImage != null)
            {
                if(pic3.BackgroundImage.Equals(picTerra.BackgroundImage))
                    picValida3.BackgroundImage = certo;
                else
                    picValida3.BackgroundImage = erro;
            }
        }
        ...
        private void pic4_MouseMove(object sender, MouseEventArgs e)
        {
            if (pic4.BackgroundImage != null)
            {
                if (pic4.BackgroundImage.Equals(picMarte.BackgroundImage))
                    picValida4.BackgroundImage = certo;
                else
                    picValida4.BackgroundImage = erro;
            }
        }
        ...
        private void pic5_MouseMove(object sender, MouseEventArgs e)
        {
            if(pic5.BackgroundImage != null)
            {
                if(pic5.BackgroundImage.Equals(picJupiter.BackgroundImage))
                    picValida5.BackgroundImage = certo; 
                else
                    picValida5.BackgroundImage = erro; 
            }
        }
        ...
        private void pic6_MouseMove(object sender, MouseEventArgs e)
        {
            if (pic6.BackgroundImage != null)
            {
                if(pic6.BackgroundImage.Equals(picSaturno.BackgroundImage))
                    picValida6.BackgroundImage = certo;
                else
                    picValida6.BackgroundImage = erro;
        ...
        private void pic8_MouseMove(object sender, MouseEventArgs e)
        {
            if (pic8.BackgroundImage != null)
            {
                if(pic8.BackgroundImage.Equals(picNetuno.BackgroundImage))
                    picValida8.BackgroundImage = certo;
                else
                    picValida8.BackgroundImage = erro;
            }
        }
        ...
        private void picUrano_MouseDown(object sender, MouseEventArgs e)
        {
            PictureBox pic = (PictureBox)sender;
            pic.DoDragDrop(picUrano.BackgroundImage, DragDropEffects.Copy| DragDropEffects.Move);
        ...
        private void pic7_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            {
                if (pic7.BackgroundImage.Equals(picUrano.BackgroundImage))
                    picValida7.BackgroundImage = certo;
                else
                    picValida7.BackgroundImage = erro;
            }
        }
        ...
        private void DragDrop_FormClosed(object sender, FormClosedEventArgs e)
        {
            timer1.Stop();
        }
    }
